...
class IPHI_constant(nn.Module):
    def __init__(self, width=40):
        super(IPHI_constant, self).__init__()
...
class IPHI(nn.Module):
    ...
    def forward(self, x, code=None):
        ...
        x_sin = torch.sin(self.B * xd.view(b,n,d,1)).view(b,n,d*self.width//4).cuda()
        x_cos = torch.cos(self.B * xd.view(b,n,d,1)).view(b,n,d*self.width//4).cuda()
