...
# model.load_state_dict(torch.load(os.path.join(model_dir, 'model_FNO2D.pt')))
# model_iphi.load_state_dict(torch.load(os.path.join(model_dir, 'model_iphi_constant_FNO2D.pt')))
# run.finish()
